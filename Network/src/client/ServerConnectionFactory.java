...
public class ServerConnectionFactory {
	...
	/**
	 * Creates a new Instance of ServerConnection and returns it.
	 * @param checkInterval	The Interval in ms, the Connectivity to the Server shall be checked 
	 * 						by the ServerConnection.
	 * @param isAndroid	If the Client is an Android-Client, this value has to be {@code true}, 
	 * 					{@code false} else.
	 * @param version	The Version, the ServerConnection will use.
	 * @return	The new ServerConnection Instance.
	 * @since 1.1
	 */
